  ...
  return (
    <main className="w-full bg-blue-50 ml-4">
      <div className="w-full px-4 py-6">
        <div className="flex items-center py-2 px-4 rounded mb-0 mt-3">
        ...
        <div className="flex flex-col md:flex-row items-center">
          <div className="md:w-1/2">
            <h1 className="text-4xl font-bold text-black ml-7 mt-0">
            ...
            <div className="mt-7 flex items-center ml-6">
            ...
            <p className="mt-6 text-gray-600 ml-8">Trusted by 0000+ schools</p>
          </div>
          
          <div className="md:w-1/2 mt-2 md:mt-0 flex justify-end overflow-hidden relative">
            <div className="relative w-full h-full">
              <img
                ...
                className="rounded-lg shadow-lg transform scale-105 object-cover"
              />
            </div>
          </div>
        </div>
